...
import { createCostSpanProcessor } from '../../../src/otel/cost-processor.js';
import type { SpanProcessor as CostSpanProcessor } from '../../../src/processor/processor.js';
import { createCostMetricReader } from '../../../src/otel/metric-reader.js';
...
} from '../../../src/semconv/attributes.js';
...
describe('createCostSpanProcessor', () => {
  ...
  describe('onStart', () => {
    it('should be a no-op and not throw', () => {
      expect(() => otelProcessor.onStart({} as any, {} as any)).not.toThrow();
    });
  });
  ...
  describe('onEnd', () => {
    ...
    it('should not throw when span is null', () => {
      expect(() => otelProcessor.onEnd(null as any)).not.toThrow();
    });

    it('should not throw when span has undefined attributes', () => {
      const span = makeOtelSpan({ attributes: undefined as any });
